...
const Models = () => {
  const models = [
    ...
    {
      name: 'Llama 3 8B',
      file: 'Meta-Llama-3-8B-Instruct.Q3_K_L.gguf',
      ram: '8 GB RAM',
      size: '4.32 GB',
      tag: 'Max Power',
    },
      ...
      <div className="section-container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Rivo supports standard quantized GGUF weights. Your hardware specs
            are dynamically mapped to recommend the most optimal model.
          </p>
        </div>
          ...
          <table className="models-table">
            ...
            <tbody>
              {models.map((model, idx) => (
                <tr
                  key={idx}
                  className={model.tag === 'Recommended' ? 'highlight-row' : ''}
                >
                  ...
                  <td>
                    <span className="ram-badge">{model.ram}</span>
                  </td>
